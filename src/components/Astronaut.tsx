import { useRef, FC, JSX } from "react";
import { useGLTF, useAnimations } from "@react-three/drei";
import { Group, SkinnedMesh, Material, AnimationClip } from "three";
import { useFallingAnimation, useGLTFAnimationPlay } from "../utils/hooks";
...
const Astronaut: FC<Props> = ({ ...props }) => {
  ...
  useGLTFAnimationPlay(animations, actions, 0);
  useFallingAnimation(group, 5, -1, 30);
